...
# Setup a kind cluster for OpenClaw Enterprise local development with a local registry.
...
KIND_CLUSTER_NAME="${KIND_CLUSTER_NAME:-openclaw-dev}"
KIND_CONFIG="${KIND_CONFIG:-kind-config.yaml}"
KF_HOST_PORT_80="${KF_HOST_PORT_80:-8880}"
